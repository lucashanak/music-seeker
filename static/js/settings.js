  ...
  const html = `<div style="display:flex;flex-direction:column;gap:12px;">
    ...
    <details class="perm-section" open>
      ...
      <div class="perm-section-body">
        ...
        <label class="perm-check" title="P2P stahování přes síť Soulseek, preferuje zvolený formát"><span>Soulseek</span> <input type="checkbox" id="ep_slskd" ${meths.includes('slskd') ? 'checked' : ''}></label>
