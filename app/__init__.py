...
def create_app() -> FastAPI:
    ...
    # Include routers
    from app.routers import auth, search, spotify as spotify_router, downloads, player, discover, favorites, podcasts, settings, admin, library as library_router, dlna as dlna_router
